...
/**
  ...
  next "prepare" (in the next iteration of the eventBus loop). This corresponds
  pretty closely to the amount of time spent in eventBus handlers (such as the
  ...
  "prepare" and the next "check" (in the same iteration of the eventBus loop), and
...
main(int argc, char **argv)
{
	...
	/* run the eventBus loop until interrupted */
